 ...
 * therefore catch at the Node.js level and normalise into a discriminated union.
 *
...
async function tauriInvoke<T>(
  ...
  try {
    ...
    // Tauri Err(String) arrives here as a WebDriverError whose message IS the
    // backend error string — extract it by stripping the WebdriverIO wrapper.
