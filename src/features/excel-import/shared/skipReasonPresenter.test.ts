...
describe("formatSkipReason", () => {
  ...
  it("maps unit variants to their bare keys", () => {
    const cases: Array<[SkipReason, string]> = [
      [{ code: "MissingPatientName" }, "excel-import:parsingReport.reasons.missing_patient_name"],
      [
        { code: "MissingFundIdentifier" },
        "excel-import:parsingReport.reasons.missing_fund_identifier",
      ],
      [{ code: "MissingFundName" }, "excel-import:parsingReport.reasons.missing_fund_name"],
      [{ code: "UnknownSheetName" }, "excel-import:parsingReport.reasons.unknown_sheet_name"],
    ];
