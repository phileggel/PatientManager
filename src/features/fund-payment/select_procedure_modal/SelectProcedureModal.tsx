...
import { NativeDialog } from "@/ui/components/modal";
...
export function ProcedureSelectionModal({
  ...
  // Opened from inside EditFundPaymentModal: the native top layer stacks this
  // dialog above its parent by open order (ADR-008), no z-index tier needed.
  return (
    <NativeDialog
      id="select-procedure-modal"
      onClose={onCancel}
      aria-labelledby="select-modal-title"
      className="bg-m3-surface-container-lowest/85 backdrop-blur-[12px] rounded-[28px] shadow-elevation-4 w-full max-w-3xl max-h-[90vh] overflow-hidden flex-col open:flex"
    >
      {/* Header */}
