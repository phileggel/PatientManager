---
name: spec-checker
description: Verifies that all business rules (R1, R2… Rn) in a feature spec doc are fully implemented in code and covered by tests. Use before marking a feature complete.
